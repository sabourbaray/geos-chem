...
!  Fast-JX. This module is used only in Fast-JX and not in Cloud-J.
!\\
!\\
! !INTERFACE:
!
...
!!!INTEGER, PARAMETER :: N_ = 1201
  ...
  !-----------------------------------------------------------------------
  ! Array dimension sizes set in Init_CMN_FastJX at run-time
  !-----------------------------------------------------------------------
  ...
  INTEGER :: JTAUMX         ! Max # divisions, i.e. < ATAUMN (NOTE: not in Cloud-J)
