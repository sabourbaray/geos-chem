...
!BOP
!
! !MODULE: aer_container_mod.F90
!
! !DESCRIPTION: Module AER\_CONTAINER\_MOD contains the derived type used
!  to store aerosol data used for computing optical depths and diagnostics.
!\\
!\\
! !INTERFACE:
!
MODULE Aer_Container_Mod
!
! USES:
!
  USE ErrCode_Mod
...
!
  PUBLIC :: Init_Aer_Container
  PUBLIC :: Cleanup_Aer_Container
!
! !PUBLIC DATA MEMBERS:
!
  !=========================================================================
...
! !INTERFACE:
!
  SUBROUTINE Init_Aer_Container( Input_Opt, State_Grid, Aer, RC )
!
! !USES:
!
...
!
    TYPE(AerContainer),  POINTER     :: Aer       ! Aerosol data container
!
! !OUTPUT PARAMETERS:
!
...
!
    ...
    !======================================================================
    ! Init_Aer_Container starts here
    !======================================================================

    ! Initialize local variables
    RC = GC_SUCCESS
    thisLoc = ' -> at Init_Aer_Container (in module Headers/aer_container_mod.F90)'
    NX = State_Grid%NX
    NY = State_Grid%NY
    NZ = State_Grid%NZ
...
!BOP
!
! !IROUTINE: Cleanup_Aer_Container
!
...
! !INTERFACE:
!
  SUBROUTINE Cleanup_Aer_Container( Aer, RC )
!
! !INPUT/OUTPUT PARAMETERS:
!
    TYPE(AerContainer), POINTER     :: Aer   ! Aer data container
!
! !OUTPUT PARAMETERS:
!
...
!BOC
    ...
    !======================================================================
    ! Cleanup_Aer_Container starts here
    !======================================================================
  ...
  END SUBROUTINE Cleanup_Aer_Container
!EOC

END MODULE Aer_Container_Mod
