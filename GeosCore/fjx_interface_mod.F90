!#ifndef CLOUDJ  !! Always compile for now because of mercury
!------------------------------------------------------------------------------
...
!
  PRIVATE :: RD_PROF_NC ! NC-read version of what is in cloud-j
...
!    USE Charpak_Mod,    ONLY : CSTRIP
    ...
    USE CMN_FastJX_Mod, ONLY : BRANCH, JIND    ! ewl debugging
    USE ErrCode_Mod
...
!    ! ewl debugging
!    print *, " "
!    print *, "In Init_FastJX"
!    print *, "ewl: NRATJ: ", NRATJ
!    print *, "ewl: JLABEL(1): ", JLABEL(1)
!    print *, "ewl: RNAMES(1): ", RNAMES(1)
!    print *, "ewl: JIND(1): ", JIND(1)
!    print *, "ewl: JFACTA(1): ", JFACTA(1)
!    print *, "ewl: BRANCH(1): ", BRANCH(1)
...
!#endif ! Always compile for now because of mercury
